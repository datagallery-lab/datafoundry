# Open Data Agent 中文文档

Open Data Agent 是一个面向数据分析场景的 AI 工作台。它把自然语言提问、数据源管理、只读 SQL 执行、分析追溯和结果产出放在同一个工作流里，帮助用户更快完成探索性数据分析。

这套文档面向产品试用、客户演示、开源访客和集成开发者。当前公开文档以中文为主；英文文档会在中文内容稳定后统一补齐。
...
2. 按 [快速开始](quick-start.md) 配置模型 API Key，并使用内置 DuckDB 演示数据源跑通第一个问题。
