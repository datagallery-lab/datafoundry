...
| 4 | [Supported Databases](engineering/supported-databases.md) | 当前 Data Gateway 支持的数据库类型、字段和使用方式 |
| 5 | [File Asset / Workspace / Artifact / Knowledge 设计](engineering/2026-06-24-file-asset-workspace-artifact-knowledge-design.md) | 文件资产、workspace、artifact、KB 的统一生命周期 |
| 6 | [前端能力现状（自述快照）](engineering/2026-06-25-frontend-capability-status.md) | 前端已实现状态、字段接线与占位现状 |
| 7 | [对后端的能力要求](engineering/2026-06-25-backend-requirements.md) | 给后端的需求清单、验收、排期与答复区 |
| 8 | [Data Task 页面设计](../apps/web/src/app/data-tasks/DESIGN.md) | `/data-tasks` UI 映射、状态模型 |
| 9 | [AG-UI Agent Runtime 架构图](engineering/ag-ui-agent-runtime-architecture.svg) | 运行时结构示意 |
| 10 | 下方 Research / Product / PRD / 早期 Engineering | 历史输入，可能滞后于代码 |
...
| [Supported Databases](engineering/supported-databases.md) | 当前 Data Gateway 支持的数据库列表、配置字段、注册示例和 agent 使用方式。 | Current |
...
- [Supported Databases](engineering/supported-databases.md)
