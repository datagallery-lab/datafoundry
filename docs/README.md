...
| 5 | [前端 → 后端能力需求清单](engineering/frontend-backend-capability-requests.md) | 前端提出的能力需求、缺口与排期 |
| 6 | [后端能力交付状态](engineering/2026-06-23-frontend-backend-capability-status.md) | 对能力需求的后端实现状态 |
