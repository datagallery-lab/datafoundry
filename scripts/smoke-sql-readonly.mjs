...
try {
  ...
  assert(succeededLogs.length >= 2, `expected at least 2 succeeded audit logs, got ${succeededLogs.length}`);
  assert(blockedLogs.length === 7, `expected 7 blocked audit logs, got ${blockedLogs.length}`);
